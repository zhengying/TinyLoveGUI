...
--     guiContext:resize(w, h)    
-- end

-- function love.mousepressed(x, y, button, istouch, presses)
--     guiContext:mousepressed(x, y, button, istouch, presses)
-- end

-- function love.mousereleased(x, y, button, istouch, presses)
--     guiContext:mousereleased(x, y, button, istouch, presses)
-- end

-- function love.mousemoved(x, y, dx, dy, istouch)
--     guiContext:mousemoved(x, y, dx, dy, istouch)
-- end

-- function love.wheelmoved(x, y)
--     guiContext:wheelmoved(x, y)
-- end

-- function love.textinput(text)
--     guiContext:textinput(text)
-- end

-- function love.keypressed(key, scancode, isrepeat)
--     guiContext:keypressed(key, scancode, isrepeat)
-- end
